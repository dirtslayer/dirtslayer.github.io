...
Splitting loot with another player is not a good idea, so split up early and team later.
...
The Sub Machine Gun was modified for the zbr game mode to accept the 50 round magazine. The VSS would be OP with a 50 round mag, but still can use the 40 round.

## Killing Zombies

Basically you want to avoid fighting more than 1 at a time. Your primary concern isn't killing, but not dying. Have one CQC (close quarters combat) weapon ready. I like to use the shotgun early to conserve ammo for smg and Ak/AR/SCAR later in the round. 

If they are doing damage they will try to get under you, so strafe around them as you jump and fire down. If you are really in a tough situation use grenade or knife (4 or 5) to run faster and don't look back.

Do not rush to kill as many as possible, just focus on killing the zombies that could damage you. You should consider carrying a weapon that can do damage at long range - 50 cal, sniper, xbow, or hunting rifle.
